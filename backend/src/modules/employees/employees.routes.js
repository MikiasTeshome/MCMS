...
import { getEmployees, getPrintCards, createEmployee, bulkImportEmployees, updateEmployee, deleteEmployee } from './employees.controller.js';
...
router.get('/print-cards', protect, authorize('ADMIN', 'HR'), getPrintCards);
